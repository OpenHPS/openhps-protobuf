...
describe('Serializer', () => {
    before(async function () {
        // initialize() generates the entire .proto project for every serializable type
        // in @openhps/core before it can load anything. That is well past the 20s
        // default, and it is setup cost, not a slow assertion.
        this.timeout(300000);
    ...
    describe('deserialize()', () => {
        it('should deserialize units', () => {
            ...
            velocity.linear = new LinearVelocity(1, 0, 0, LinearVelocityUnit.METER_PER_SECOND).setAccuracy(
                new Accuracy1D(1, LinearVelocityUnit.CENTIMETER_PER_SECOND),
            );
