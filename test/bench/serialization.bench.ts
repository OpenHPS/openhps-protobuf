...
ProtobufSerializer.initialize()
    .then(() => {
        suite
            .add(
                'dataserializer#serialize (simple)',
                () => {
            ...
            .add(
                'dataserializer#deserialize (simple)',
                () => {
            ...
            .add(
                'protobufserializer#serialize (simple)',
                () => {
            ...
            .add(
                'protobufserializer#deserialize (simple)',
                () => {
            ...
            // }, settings)
            .add(
                'dataserializer#serialize (advanced)',
                () => {
            ...
            .add(
                'dataserializer#deserialize (advanced)',
                () => {
                    deserialized = DataSerializer.deserialize(serialized);
                },
                settings,
            ...
            .add(
                'protobufserializer#serialize (advanced)',
                () => {
            ...
            .add(
                'protobufserializer#deserialize (advanced)',
                () => {
                    deserialized = ProtobufSerializer.deserialize(serialized);
                },
                settings,
